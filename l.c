...
int main(void)
{
	...
	//this if/while loop determines the number of character is username
	x=i+1;
	int u;
	...
	// printf("n=%d,y=%d,x=%d<br />",n,y,x);

	char password[y];

	// printf("chara user:%d, char passw:%d, i:%d<br />",u,y,i);

	//this part readys inputArray and puts the characters in the username
	int j = 0;
	i = 9;
